...
# ==================================================================================== #
# LAMMPS from SPACK @ CPU
# ==================================================================================== #

# ------------------------> Modify here ! <------------------------ #
PYTHON_VENV_PATH=${HOME}/builds/flare-lammps-gcc12-openblas
INSTALL_DIR=${HOME}/builds/lammps/builds/stable_2Aug2023_update3/cpu-gcc12-openblas-flare-plumed_lammps-02082023
BUILD=${HOME}/builds
# ----------------------------------------------------------------- #

# (*) Load modules
module purge
spack install python@3.9.19 %gcc@12.2.0
