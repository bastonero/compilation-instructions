...
# -----------------> Modify here <----------------- #
LAMMPS_PATH=$HOME/builds/lammps/builds/lammps-release-gpu-kokkos-flare-plumed
# ------------------------------------------------- #
...
srun lmp -k on g ${gpu_count} t ${OMP_NUM_THREADS} -sf kk -pk kokkos newton on neigh half -in in.lammps