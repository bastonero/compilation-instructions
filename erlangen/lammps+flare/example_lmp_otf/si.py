...
os.environ["ESPRESSO_PSEUDO"] = "/home/hpc/e103ef/e103ef10/pseudos/SSSP/1.3/PBEsol/precision"
os.environ["ASE_ESPRESSO_COMMAND"] = f"srun {pwx} -sirius -sirius_cfg sirius.json -in PREFIX.pwi > PREFIX.pwo"
...
dftcalc = Espresso(
    ...
    input_data={
        'control':{
            'pseudo_dir':'/home/hpc/e103ef/e103ef10/pseudos/SSSP/1.3/PBEsol/precision',
            'outdir':'./out',
        },
        'system':{
            'ecutwfc': cut,
